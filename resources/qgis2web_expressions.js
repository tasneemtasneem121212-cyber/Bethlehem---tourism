...
function exp_Roads_2rule0_eval_expression(context) {
    // RoadType_E = 'internal'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('RoadType_E')  == 'internal');
    } else {
        return (feature.get('RoadType_E')  == 'internal');
    }
}
...
function exp_Roads_2rule1_eval_expression(context) {
    // RoadType_E = 'Local'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('RoadType_E')  == 'Local');
    } else {
        return (feature.get('RoadType_E')  == 'Local');
    }
}
...
function exp_Roads_2rule2_eval_expression(context) {
    // RoadType_E = 'Main'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('RoadType_E')  == 'Main');
    } else {
        return (feature.get('RoadType_E')  == 'Main');
    }
}
...
function exp_Roads_2rule3_eval_expression(context) {
    // RoadType_E = 'Regional'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('RoadType_E')  == 'Regional');
    } else {
        return (feature.get('RoadType_E')  == 'Regional');
    }
}
...
function exp_Roads_2rule4_eval_expression(context) {
    // RoadType_E = 'Roundabout'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('RoadType_E')  == 'Roundabout');
    } else {
        return (feature.get('RoadType_E')  == 'Roundabout');
    }
}
...
function exp_Roads_2rule5_eval_expression(context) {
    // RoadType_E = 'Settlement'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('RoadType_E')  == 'Settlement');
    } else {
        return (feature.get('RoadType_E')  == 'Settlement');
    }
}
...
function exp_Roads_2rule6_eval_expression(context) {
    // RoadType_E = 'Unused'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('RoadType_E')  == 'Unused');
    } else {
        return (feature.get('RoadType_E')  == 'Unused');
    }
}